...
const SHEEP_VISUAL_RADIUS: f32 = 15.;
        ...
        (1..15).for_each(|y| {
            new_world.sheep.push(Sheep::new(
                ...
                vector![
                    ...
                    y as f32 * 2.0 + WINDOW_SIZE_METERS.1 as f32 * 0.50 - 10.0
                ],
                vector![0.0, 0.0],
                sheep_rules,
            ))
    ...
    (0..20).for_each(|x| {
        (0..3).for_each(|y| {
            new_world.dynamic_obstacles.push(DynamicObstacle::new(
                &mut new_world.physics_state,
                vector![
                    x as f32 * 12.0 - y as f32 * 12.0,
                    WINDOW_SIZE_METERS.1 as f32 - x as f32 * 12.0,
                ],
                5.0,
            ))
        });
...
async fn main() {
    ...
    let goal = Vector2::new(
        WINDOW_SIZE_METERS.0 as f32 * 0.75,
        WINDOW_SIZE_METERS.1 as f32 * 0.75,
    );
